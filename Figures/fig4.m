...
lessthansevenfive = lsthn/numpts
%set(gca,'YScale','log')
...
xlabel('Distance from Nearest Neighbor (cm)','FontSize',axislabelsize)
ylabel('Counts','FontSize',axislabelsize)
%xlim([0, 40])
%ylim([100, 10^6])
title(sprintf("Histogram %d Nearest Neighbor Distances",numNeighbors),'FontSize',titlesize)
